...
| 分支 | 状态 | 说明 |
| --- | --- | --- |
| `main` | v3 alpha | Next.js + TypeScript 重构主线 |
...
| 单词测试 | 已迁移 | 多选单元、自定义词表、测试结果、错题本、导入导出、云同步 |
...
- `LSCUBE_OAUTH_AUTHORIZE_URL`
- `LSCUBE_OAUTH_TOKEN_URL`
- `LSCUBE_OAUTH_USERINFO_URL`
- `LSCUBE_OAUTH_CLIENT_ID`
- `LSCUBE_OAUTH_CLIENT_SECRET`（可选；OAuth 流程默认启用 PKCE S256）
- `LSCUBE_OAUTH_CLIENT_AUTH_METHOD`（可选：`none`、`post`、`basic`）
- `LSCUBE_OAUTH_REDIRECT_URI`
- `LSCUBE_OAUTH_SCOPE`
- `SESSION_SECRET`
- `R2_ACCOUNT_ID`
- `R2_ACCESS_KEY_ID`
